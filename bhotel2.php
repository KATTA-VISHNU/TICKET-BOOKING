  ...
  <div class="card-body  ">
    <?php 
        ...
        echo "<h4>YOUR HOTEL IS BOOKED!</h4>";
         ...
         echo "HOTEL NAME:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$hname2."<br>";
         echo "COST:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$cost2."<br>";
...
// Database connection parameters
       ...
       /*  $que="select * from cab_book;";
        ...
        $insertQuery = "INSERT INTO hotel1 VALUES ('$destination')";
         ...
         $q="create table if not exists book_hotel_2(destination varchar(255) NOT NULL,checkin date NOT NULL,
        ...
        $insertQuery = "INSERT INTO book_hotel_2 (destination, checkin, checkout, rooms, guests, nationality, residence,hotel_name,price)
        VALUES ('$destination', '$checkin', '$checkout', '$rooms', '$guests', '$nationality', '$residence','$hname2','$cost2')";
