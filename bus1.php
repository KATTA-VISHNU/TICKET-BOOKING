...
<div class="card mt-5">
  <div class="card-body">
    ...
    $cost1=$_POST['cost1'];
         ...
         echo "TRAVELS NAME:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$name1."<br>";
         echo "TICKET COST:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$cost1."<br>";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $createTableSQL = "CREATE TABLE IF NOT EXISTS apsrtc(
        ...
        bus_company varchar(225) not null,
    ...
    echo "hotel name: ".$name1  . "<br>";
    echo "hotel name: ".$cost1  . "<br>";
    $sql1 = "insert into apsrtc(username, useraddress, source, destination, departure_date,bus_company,cost) VALUES ('$name', '$address', '$source', '$destination', '$departure_date','$name1','$cost1');";
