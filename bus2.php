  ...
  <div class="card-body">
    ...
    $cost2=$_POST['cost2'];
        ...
        echo "<h4>YOUR BUS IS BOOKED!</h4>";
         ...
         echo "TRAVELS NAME:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$name2."<br>";
         echo "TICKET COST:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$cost2."<br>";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $createTableSQL = "CREATE TABLE IF NOT EXISTS ts_rtc(
    ...
    $sql1 = "insert into ts_rtc(username, useraddress, source, destination, departure_date,company_name,cost) VALUES ('$name', '$address', '$source', '$destination', '$departure_date','$name2','$cost2');";
