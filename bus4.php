  ...
  <div class="card-body">
    ...
    $cost4=$_POST['cost4'];
        ...
        echo "<h4>YOUR BUS IS BOOKED!</h4>";
         ...
         echo "TRAVELS NAME:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$name4."<br>";
         echo "TICKET COST:&nbsp&nbsp&nbsp&nbsp &nbsp  ".$cost4."<br>";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $createTableSQL = "CREATE TABLE IF NOT EXISTS a_buses(
    ...
    $sql1 = "insert into a_buses(username, useraddress, source, destination, departure_date,company_name,cost) VALUES ('$name', '$address', '$source', '$destination', '$departure_date','$name4','$cost4');";
