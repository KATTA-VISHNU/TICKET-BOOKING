...
<body>
    ...
    const modalForm = document.getElementById("modal-form"); // Changed to target the form inside the modal
    const submitButton = document.getElementById("submitBtn");
    const skipButton = document.querySelector(".skipBtn");
    const closeButton = document.querySelector(".close");
    const successMessage = document.querySelector(".success-message");
    const errorMessage = document.querySelector(".error-message");
    const invalidCouponMessage = document.querySelector(".invalid-coupon-message"); // New element for invalid coupon message
   ...
   invalidCouponMessage.style.display = "none";
            invalidMobileMessage.style.display = "block";
            successMessage.style.display = "none";
            errorMessage.style.display = "none";
        } else {
            invalidCouponMessage.style.display = "none";
